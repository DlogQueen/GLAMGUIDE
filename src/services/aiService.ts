...
> = {
  natural: {
    ...
    difficulty: "beginner",
    baseColors: ["nude", "beige", "peach"],
  },
  soft: {
    tags: ["soft", "romantic", "gentle"],
    difficulty: "beginner",
    baseColors: ["pink", "peach", "mauve"],
  },
  romantic: {
    tags: ["romantic", "soft", "feminine"],
    difficulty: "beginner",
    baseColors: ["rose", "pink", "champagne"],
  },
  dewy: {
    tags: ["dewy", "glowing", "k-beauty"],
    difficulty: "beginner",
    baseColors: ["champagne", "pearl", "gold"],
  },
  glow: {
    tags: ["glowing", "dewy", "luminous"],
    difficulty: "beginner",
    baseColors: ["gold", "bronze", "champagne"],
  },
  pink: {
    tags: ["pink", "feminine", "romantic"],
    difficulty: "beginner",
    baseColors: ["pink", "rose", "mauve"],
  },
  smokey: {
    tags: ["evening", "glam", "seductive"],
    difficulty: "intermediate",
    baseColors: ["grey", "black", "silver"],
  },
  bold: {
    tags: ["dramatic", "statement", "bold"],
    difficulty: "intermediate",
    baseColors: ["red", "burgundy", "plum"],
  },
  dramatic: {
    tags: ["dramatic", "evening", "glam"],
    difficulty: "advanced",
    baseColors: ["black", "deep purple", "gold"],
  },
  glitter: {
    tags: ["glam", "party", "sparkle"],
    difficulty: "intermediate",
    baseColors: ["silver", "gold", "glitter"],
  },
  vintage: {
    tags: ["vintage", "classic", "retro"],
    difficulty: "intermediate",
    baseColors: ["red", "cream", "black"],
  },
  editorial: {
    tags: ["editorial", "fashion", "artistic"],
    difficulty: "advanced",
    baseColors: ["white", "black", "neon"],
  },
  spring: {
    tags: ["spring", "fresh", "pastel"],
    difficulty: "beginner",
    baseColors: ["peach", "coral", "mint"],
  },
  summer: {
    tags: ["summer", "bronze", "warm"],
    difficulty: "beginner",
    baseColors: ["bronze", "coral", "gold"],
  },
  fall: {
    tags: ["fall", "warm", "earthy"],
    difficulty: "intermediate",
    baseColors: ["burgundy", "copper", "olive"],
  },
  winter: {
    tags: ["winter", "cool", "icy"],
    difficulty: "intermediate",
    baseColors: ["silver", "icy blue", "plum"],
  },
  bridal: {
    tags: ["bridal", "elegant", "timeless"],
    difficulty: "intermediate",
    baseColors: ["champagne", "rose gold", "ivory"],
  },
  neon: {
    tags: ["neon", "bold", "creative"],
    difficulty: "advanced",
    baseColors: ["neon pink", "electric blue", "lime"],
  },
  mermaid: {
    tags: ["mermaid", "shimmer", "iridescent"],
    difficulty: "advanced",
    baseColors: ["teal", "purple", "iridescent"],
  },
  goth: {
    tags: ["goth", "dark", "mysterious"],
    difficulty: "intermediate",
    baseColors: ["black", "deep red", "purple"],
  },
  golden: {
    tags: ["golden", "luxury", "glam"],
    difficulty: "intermediate",
    baseColors: ["gold", "bronze", "champagne"],
  },
  copper: {
    tags: ["copper", "warm", "metallic"],
    difficulty: "intermediate",
    baseColors: ["copper", "bronze", "peach"],
  },
  berry: {
    tags: ["berry", "rich", "autumn"],
    difficulty: "intermediate",
    baseColors: ["berry", "plum", "wine"],
  },
  coral: {
    tags: ["coral", "fresh", "spring"],
    difficulty: "beginner",
    baseColors: ["coral", "peach", "orange"],
  },
  peach: {
    tags: ["peach", "warm", "natural"],
    difficulty: "beginner",
    baseColors: ["peach", "apricot", "coral"],
  },
  mauve: {
    tags: ["mauve", "sophisticated", "muted"],
    difficulty: "intermediate",
    baseColors: ["mauve", "dusty rose", "taupe"],
  },
  rose: {
    tags: ["rose", "romantic", "soft"],
    difficulty: "beginner",
    baseColors: ["rose", "pink", "gold"],
  },
  champagne: {
    tags: ["champagne", "elegant", "neutral"],
    difficulty: "intermediate",
    baseColors: ["champagne", "gold", "beige"],
  },
  burgundy: {
    tags: ["burgundy", "deep", "rich"],
    difficulty: "intermediate",
    baseColors: ["burgundy", "wine", "oxblood"],
  },
};
...
function analyzeDescription(description: string): {
  ...
  if (
    ...
    lowerDesc.includes("glam")
  ) {
    sentiment = "glamorous";
  } else if (
    lowerDesc.includes("natural") ||
    lowerDesc.includes("soft") ||
    lowerDesc.includes("minimal")
  ) {
    sentiment = "natural";
  } else if (
    lowerDesc.includes("creative") ||
    lowerDesc.includes("artistic") ||
    lowerDesc.includes("editorial")
  ) {
    sentiment = "creative";
  }
...
function generateSteps(
  ...
  const baseSteps: MakeupStep[] = [
    {
      ...
      instruction:
        "Cleanse your face and apply moisturizer. Wait 2 minutes for it to absorb before starting makeup.",
      duration: 180,
    ...
    },
    {
      ...
      instruction:
        "Apply foundation or BB cream with a damp sponge, blending from center of face outward.",
      duration: 180,
      targetAreas: ["whole_face"],
    ...
    },
    {
      ...
      instruction:
        "Apply concealer under eyes, around nose, and on any blemishes. Blend with sponge or brush.",
      duration: 120,
  ...
  if (
    keywords.some((k) => ["smokey", "dramatic", "bold", "glam"].includes(k))
  ) {
    eyeSteps.push({
      id: "custom-eye-1",
      order: 4,
      ...
      instruction:
        "Apply eyeshadow primer all over lid from lash line to brow bone.",
      duration: 60,
      targetAreas: ["eyelids"],
      tools: ["fingertip"],
    ...
    eyeSteps.push({
      ...
      description: keywords.some((k) => ["smokey", "dramatic"])
    ...
    eyeSteps.push({
      ...
      instruction:
        "Apply a single neutral shadow all over lid and blend into crease. Add subtle liner if desired.",
      duration: 120,
      targetAreas: ["eyelids"],
  ...
  eyeSteps.push({
    ...
    products: [
      "eyeliner",
      "mascara",
      ...(keywords.some((k) => ["dramatic", "bold"].includes(k))
        ? ["false lashes"]
        : []),
    ],
  ...
  const faceSteps: MakeupStep[] = [
    ...
    },
    {
      ...
      instruction:
        "Smile and apply blush to apples of cheeks, blending upward toward temples.",
      duration: 60,
      targetAreas: ["cheeks"],
      tools: ["blush brush"],
      products: ["blush"],
    ...
    },
    {
      ...
      instruction:
        "Apply highlighter to high points of face - cheekbones, nose bridge, cupid's bow, and inner eye corners.",
      duration: 90,
      targetAreas: ["cheekbones", "nose_bridge", "philtrum"],
      tools: ["highlighter brush"],
      products: ["highlighter"],
      tips: [
        "Build gradually for natural glow",
        "Cream highlighter for dewy finish",
      ],
    },
  ];
  ...
  const browStep: MakeupStep = {
    ...
    instruction:
      "Fill in sparse areas of brows with feathery strokes and set with gel.",
    duration: 90,
    ...
    tips: [
      ...
      "Brush hairs upward for fluffy look",
    ],
  };
  ...
  const finishStep: MakeupStep = {
    ...
    instruction:
      "Set makeup with setting powder where needed and mist with setting spray.",
    duration: 60,
    targetAreas: ["whole_face"],
...
async function generateWithOpenRouter(
  ...
  const response = await fetch(OPENROUTER_API_URL, {
    ...
    headers: {
      ...
      "HTTP-Referer":
        "https://makeup-mastery-fjf344mer-scars-projects-703c493a.vercel.app",
...
export async function generateCustomMakeupStyle(
  prompt: string,
): Promise<MakeupStyle | null> {
  try {
    ...
    return {
      ...
      description:
        result.description || `A ${result.difficulty}-level makeup look`,
...
export async function generateCoachingTip(
  ...
  // Local-only coaching tips (no external AI provider)
  ...
  const progressHint =
    userProgress >= 85
      ? "You're almost done with this step."
      : userProgress >= 50
        ? "You're halfway there—keep blending smoothly."
  ...
  return `${phrase} ${progressHint} ${tips}${contextHint}`.trim();
}
